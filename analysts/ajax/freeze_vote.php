...
$subject = 'SES Portal: Votes frozen by : '.$user->name;

	$body_in = '<p>Dear Admin,</p><p>'.$user->name.' has frozen votes for the meeting.<br>Company Name: '.$report_info["com_name"].'<br>Meeting Type: '.$meeting_types[$report_info["meeting_type"]].'<br>Meeting Date: '.date("d-M-y", $report_info["meeting_date"]).'<br>E-Voting Period: ';
