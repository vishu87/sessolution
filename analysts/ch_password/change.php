                              ...
                              <div class="tab-pane active" id="portlet_tab1">
                                 ...
                                 <form action="<?php echo $folder;?>process.php" method="post" class="form-horizontal" id="form_change">
                                    ...
                                    <div class="control-group">
                                       ...
                                       <div class="controls">
                                          <input type="password" name="new_p" id="new_p" placeholder="" class="m-wrap" onkeyup="clear_password()"><a href="javascript:;" rel="tooltip" class="btn ttip icn-only" data-placement="right" title="" data-original-title="Password must be atleast 8 charaters long. It must contain atleast one Uppercase letter (A-Z),&lt;br&gt; one special charaters ( ! @ # $ % _ ^ * &amp; ~ ) ,and one number(0-9)."><i class="icon-question-sign"></i></a>
                                          <span class="help-inline"></span>
                                       </div>
                                    </div>
