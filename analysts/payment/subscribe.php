...
if(isset($_POST["report_id"])) {
  ...
  $query_check = mysql_query("SELECT id from subscription_request where report_id='$report_id' and report_type='$report_type' ");
  if(mysql_num_rows($query_check) == 0){
    mysql_query("INSERT into subscription_request (report_id,report_type, user_id, add_date) values ('$report_id','$report_type','$_SESSION[MEM_ID]','".strtotime("now")."' ) ");
  }
