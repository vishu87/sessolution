...
<div class="container-fluid">
   ...
   <div class="row-fluid" style="margin-bottom:20px;">
    <div class="span4"> 
      ...
      <a class="btn meet5_big <?php echo ($type == 5)?'big2':''; ?>" style="color:#fff;" data-toggle="modal" href="#myModal" onclick="ccm_types()">CCM (Creditors)</a>
               ...
               <?php
                  ...
                  switch ($com_type) {
                    case 5:
                      ...
                      break;
                    case 6:
                       $member->pa_subscribed_comapnies_year($member->parent, $year_rep);
                        ...
                        <div style="min-height:130px;">
                           ...
                           <?php 
                              ...
                              if(sizeof($proxy_ids) < 5 || ( isset($type) && $type != 0 )){
                                 ...
                                 if(mysql_num_rows($sql_p) > 0) echo '<div class="meet meet4">'.mysql_num_rows($sql_p).' CCM (ES)</div>';
