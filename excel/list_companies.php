...
$sql = "SELECT * from companies order by com_name asc";
...
$ar_fields = array("sn","com_name","com_bse_code","com_bse_srcip","com_nse_sym","com_reuters","com_bloomberg","com_isin","add_date");

$ar_names = array("SN","Company Name","BSE Code","BSE Scrip","NSE Symbol","Reuters","Bloomberg","ISIN","Add Date");

$ar_width = array("6","20","8","12","13","10","10","15","10");
...
$objPHPExcel->getActiveSheet()->getStyle('A1:'.$val_chr.$seq.'')->getAlignment()->setWrapText(true);
*/
$objPHPExcel->getActiveSheet()->setTitle('SES');
