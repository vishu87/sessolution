...
while ($row_l = mysql_fetch_array($result)) {
	$locations[$row_l["id"]] = $row_l["place"];
}

$sql = "SELECT * from proxy_voters order by name asc";
...
$ar_fields = array("sn","name","email","location","mobile","add_date");

$ar_names = array("SN","Name","Email","Location","Mobile","Add Date");

$ar_width = array("6","20","20","20","20","20");
...
elseif($ar == 'location') $var = $locations[$row_att[$ar]];
...
$name = 'ProxyVoters_'.date("d-M-y", strtotime("now"));
