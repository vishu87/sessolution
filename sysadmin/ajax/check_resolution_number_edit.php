...
$sql_res_num = mysql_query("SELECT resolution_number from voting where id = '$vote_id' ");
$row_res_num = mysql_fetch_array($sql_res_num);

if($row_res_num["resolution_number"] == $resolution_number){
	echo 'success';
} else {
