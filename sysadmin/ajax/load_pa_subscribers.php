...
$users = array();
$sql_pack_user = mysql_query("SELECT users_package.user_id from users_package inner join package on users_package.package_id = package.package_id inner join package_company on package_company.package_id = package.package_id where package_company.com_id = '$_POST[id]' and package.package_year='$_POST[year]' and package.package_type='1' ");
...
$sql_addi_user = mysql_query("SELECT user_id from users_companies where com_id = '$_POST[id]' and year = '$_POST[year]' and type='1' ");
