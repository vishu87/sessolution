...
<div class="container-fluid">
	...
	<div class="row-fluid search-forms search-default">
            ...
            <div class="portlet box light-grey">
                     ...
                     <?php
                        $sql = mysql_query("select com_name, com_id, com_bse_code from companies order by com_name asc ");
...
function check_edit_submit(){
      if(validate_name($('#com_name').val(),'com_name','Please input valid name') ){
        var file = 'update_company';
         ...
         $ar_fields_all = array("com_id","com_name","com_bse_srcip","com_nse_sym","com_reuters","com_bloomberg","com_isin","com_address","com_telephone","com_website");
         $count_check =0;
