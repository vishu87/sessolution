...
<div class="container-fluid">
    ...
    <div class="span6">
      <form style="margin-top:30px; text-align:center" action="?cat=6" method="post">
            ...
            <div class="portlet box light-grey">
                     ...
                     <?php
                        ...
                        while ($year_row = mysql_fetch_array($year_sql)) {
                          ...
                          $years[$year_row["year_sh"]] = $total_comp;
                           
                            $sql = mysql_query("SELECT id from proxy_ad where year ='$year' ".$date_sql." order by meeting_date desc");
