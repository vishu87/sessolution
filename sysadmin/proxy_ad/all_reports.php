            ...
            <div class="portlet box light-grey">
                     ...
                     <?php
                        ...
                        if($date_high && $date_low){
                         $date_sql = "and meeting_date <= '$date_high' and meeting_date >= '$date_low' and skipped_on = 0";
                        } elseif ($date_high && !$date_low) {
                          $date_sql = "and meeting_date <= '$date_high' and skipped_on = 0";
                        } elseif(!$date_high && $date_low) {
                          $date_sql = "and meeting_date >= '$date_low' and skipped_on = 0";
                        } else {
                          $date_sql = "and skipped_on = 0 and meeting_date >= '$today' ";
                        }
                        ...
                        while ($year_row = mysql_fetch_array($year_sql)) {
                          ...
                          if(sizeof($total_comp) > 0){
                            ...
                            $sql = mysql_query("SELECT id from proxy_ad where com_id IN (".$str_comp.") and year ='$year' ".$date_sql." order by meeting_date asc");
