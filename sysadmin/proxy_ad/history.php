            ...
            <div class="portlet box light-grey">
                     ...
                     <?php
                        ...
                        if($date_high && $date_low){
                         $date_sql = "and meeting_date <= '$date_high' and meeting_date >= '$date_low' and skipped_on = 0 and vote_completed_on != 0 ";
                        } elseif ($date_high && !$date_low) {
                          $date_sql = "and meeting_date <= '$date_high' and skipped_on = 0 and vote_completed_on != 0";
                        } elseif(!$date_high && $date_low) {
                          $date_sql = "and meeting_date >= '$date_low' and skipped_on = 0 and vote_completed_on != 0";
                        } else {
                          $date_sql = "and skipped_on = 0 and meeting_date < '$today' and vote_completed_on != 0 ";
                        }
