...
if(!isset($title)  || !isset($aid)) {
  ...
  $sql_an = mysql_query("SELECT * from proxy_voters where vid='$aid' ");
...
<div class="container-fluid">
	...
	<div class="row-fluid">
      ...
      <div class="span6" align="right">
         <a href="proxy_voters.php?cat=2" class="btn bigicn-only" style="margin-top:10px;"><i class="m-icon-big-swapleft"></i></a>
      </div>
	</div>
                                            ...
                                            <div class="control-group">
                                             ...
                                             <div class="controls">
                                              <select name="location">
                                                <?php
                                                  $loc_sql = mysql_query("SELECT * from locations order by place asc");
                                                  while ($row_loc = mysql_fetch_array($loc_sql)) {
                                                    echo '<option value="'.$row_loc["id"].'" ';
                                                      if($row_an["location"] == $row_loc["id"]) echo 'selected';
                                                    echo '>'.$row_loc["place"].'</option>';
                                                  }
                                                ?>
