                                 ...
                                 <!-- BEGIN FORM-->
                                  <form id="attachment_form" action="<?php echo $folder?>process.php?cat=4" class="form-horizontal " method="post" >
                                   ...
                                   <div class="row-fluid">
                                       ...
                                       <div class="controls">
                                          <input type="text" name="user_admin_name" id="user_admin_name"/>
                                          <span class="help-block" ></span>
                                       </div>
                                       </div>
                                       </div>
...
function attachment_submit(){
   if(validate_required_name_idinfo($("#name").val(), 'name','Please input valid name') && validate_required_email_idinfo($("#email").val(), 'email','Please input valid email') && validate_required_number_idinfo($("#sub_users").val(), 'sub_users','Please input valid number') ){
