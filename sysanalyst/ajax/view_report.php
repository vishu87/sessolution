...
if(!isset($_POST["report_id"])  || $_SESSION["MEM_ID"] == '' || $_SESSION["PRIV"] != 2) header("Location: ".STRSITE."access-denied.php");
...
switch ($report_type) {
	...
	case '2':
		$ar_fields_name = array("Report Type","Publishing Date","Report","Governance Index","India Mandatory/Compliance Score","Board of Directors","Directors Remuneration","Stakeholder Engagement","Financial Reporting","Sustainability","Data","Deadline/Completed On","Analysis","Deadline/Completed On","Review","Deadline/Completed On");
