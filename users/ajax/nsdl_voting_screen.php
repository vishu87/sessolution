...
<a href="<?php echo $pa_report->evoting_link ?>" target="_blank" class="btn green span4">e-Vote Link</a>

<a href="javascript:;" onclick="alert('Under Construction')" class="btn blue span4">Upload Response File</a>
