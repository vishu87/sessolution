                              ...
                              <tr id="tr_<?php echo $row["id"];?>">
                                 ...
                                 <?php 
                                   echo $pa_report->report($_SESSION["MEM_ID"],$member->customized); 
                                    ...
                                    if($pa_report->subscription_request()) echo '<a href="javascript:;" class="btn green"  onclick="subscribe('.$pa_report->id.','.$pa_report->company_id.',1)">Subscribe</a>';
...
function refresh_tr(report_id){
  ...
  $.post("ajax/"+ file +".php", {count:count, id:report_id, special:1}, function(data) {
