   ...
   <div class="row-fluid">
    ...
    <div class="span6">
      <div class="btn-group" style="padding-top:20px; float:right">
        <a href="#stack1" data-toggle="modal" role="button" class="btn blue" onclick="add_meeting_voting_records()">Add a Meeting</a>
   ...
   ?>
            ...
            <div class="portlet box light-grey">
                     <div class="portlet-title">
                        <h4><i class="icon-reorder"></i>List of Past Voting Records</h4>
                         <div class="tools">
                     ...
                     <div class="portlet-body">
                       <table class="table table-stripped tablesorter">
                           ...
                           foreach ($years as $yr) {
                            ...
                            $member->voting_records_firm($member->parent);
                              ...
                              <tr id="tr_<?php echo $row["id"];?>">
                                 ...
                                 <?php 
                                    if($pa_report->subscribed($member->companies_report_subscribed_year)) echo $pa_report->report($_SESSION["MEM_ID"],$member->customized);
                                          ...
                                          if(!$pa_report->old_meeting  && $pa_report->abridged_report != '')
                               ...
                               <td><a  href="#myModal" role="button" class="btn blue" data-toggle="modal" onclick="view_report('<?php echo $pa_report->company_name; ?>', <?php echo $pa_report->id;?>)" >Details</a><a href="#stack1" data-toggle="modal" role="button" class="btn black icn-only" onclick="delete_meeting_voting_records(<?php echo $pa_report->id; ?>)"><i class="icon-remove icon-white"></i></a>
                               </td>
                               <?php ?>
                              </tr>
                              <?php $count++; }//while
...
function refresh_tr(report_id){
  ...
  $.post("ajax/"+ file +".php", {count:count, id:report_id, special:1,type:type_voting}, function(data) {
