...
if($_GET["cat"] == 1){
	...
	$alerts = mysql_real_escape_string($_POST["alerts"]);
	...
	$query = "UPDATE users set user_admin_name='$user_admin_name', address='$address', mobile='$mobile', IT_name='$IT_name', IT_email='$IT_email', IT_contact='$IT_contact',def_deadline_vote = '$def_deadline_vote', self_portfolio = '$self_portfolio', alerts = '$alerts' where id='$id' ";
