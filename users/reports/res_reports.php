                       ...
                       <table class="table table-stripped tablesorter">
                           ...
                           ?>
                              <tr id="tr_<?php echo $row["res_id"];?>">
                                 ...
                                 <td id="sub_<?php echo $res_report->id ?>"><?php 
                                  if($res_report->subscribed($user_id)) {
                                    echo $res_report->report();
                                   } else {
                                   
                                    if($res_report->subscription_request()) echo '<a href="javascript:;" class="btn green span12" style="max-width:100px;"  onclick="subscribe('.$res_report->id.','.$res_report->company_id.',3)">Subscribe</a>';
