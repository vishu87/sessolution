...
<div class="portlet box light-grey">
       <div class="portlet-title">
          <h4><i class="icon-reorder"></i>List of Past Votings</h4>
           <div class="tools">
       ...
       <div class="portlet-body">
         <table class="table table-stripped tablesorter">
             ...
             foreach ($years as $yr) {
              ...
              $query = "SELECT id from proxy_ad where id IN (".$member->voting_records_string.") and year='$yr' and meeting_date < '$today' ";
             ...
             ?>
                <tr id="tr_<?php echo $row["id"];?>">
                   ...
                   <?php 
                    ...
                    <td>
                    <?php echo $pa_report->meeting_results(); ?>
                    </td>
